...
This is the canonical shared core definition for the `7-day-mobile-and-web-design` skill.
...
Guide an AI coding or assistant environment through a structured seven-day mobile and web design workflow with clear deliverables, sequencing, and quality expectations.
...
Use this skill when the user wants a time-boxed design sprint for a product, feature, redesign, or concept that needs both mobile and web coverage.
...
- Produce outputs for both mobile and web, not just one surface
...
- note where mobile and web diverge
...
- create low-fidelity mobile and web wireframes
...
- keep mobile and web visually related but not artificially identical
...
- tighten consistency across screens and platforms
...
- do not treat web as a resized mobile layout
- do not treat mobile as a cropped desktop layout
